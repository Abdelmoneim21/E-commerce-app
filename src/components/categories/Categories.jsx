...
import { getCategories } from "../../redux-toolkit/categoriesReducer";
        ...
        {categories.slice(0,6).map((category, index) => (
          <div
            ...
            className={`hover:bg-[#db4444] hover:text-white category-box border-2 p-10 rounded-md w-[13%] h-[100%] flex flex-col items-center justify-center 
                        ${category.selected ? 'bg-red-500 text-white' : 'bg-white text-black'} transition duration-300`}
          >
            <div className="icon text-3xl mb-2 "><img src={category.image} alt="" className="w-[100%] "/></div>
