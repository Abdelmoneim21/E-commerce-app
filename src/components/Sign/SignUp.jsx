    ...
    <>
      <div className="flex flex-col md:flex-row h-auto md:h-[90vh] py-8 md:py-16 justify-between w-11/12 mx-auto">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center px-6 md:px-20">
          ...
          <button className="w-full border border-gray-300 py-3 rounded-md flex justify-center items-center hover:bg-gray-100 transition-colors">
            <img src={BsGoogle} alt="Google Logo" className="w-5 mr-2" />
            Sign up with Google
          </button>
