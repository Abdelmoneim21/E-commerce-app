...
export default function ProductDetails(){
    ...
    return(
                ...
                <div className="container mx-auto px-4 py-8">
                    ...
                    {/* // Product Images */}
                        <div className="w-full md:w-1/2 px-4 mb-8">
                            <img src={product.images && product.images.length > 0 ? product.images[0] : 'default-image-url'} alt="Product"
      ...
      <div className="w-full md:w-1/2 px-4">
            ...
            <br></br>
            <div className="mb-4">
            <span className="text-2xl font-bold mr-2">${product.price - product.price / 5}</span>
